...
const CompletedRequests = () => {
  ...
  // Fetch completed requests for the logged-in NGO
  useEffect(() => {
            ...
            {requests.map((r) => (
             const fixedImageUrl = r.imageUrl
              ...
              >
                ...
                {/* Location */}
                <p>
                  <strong>Location:</strong> {r.location?.address}
                </p>

                {/* Treatment Notes */}
                <p>
                  <strong>Treatment:</strong>{" "}
                  {r.treatment || "No treatment info"}
                </p>

                {/* Completed By */}
                <p>
                  <strong>Completed By:</strong> {r.completedBy || "Unknown"}
                </p>
